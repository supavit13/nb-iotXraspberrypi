...
while True:
    ...
    publish.single("/node1", payload=jsonData, qos=0, retain=False, hostname="m11.cloudmqtt.com",
    port=12829, client_id="", keepalive=60, will=None, auth={'username':"enotxhte", 'password':"rfB0sIYhc81n"}, tls=None)
